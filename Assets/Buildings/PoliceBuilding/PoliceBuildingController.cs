...
public class PoliceBuildingController : NeutralBuildingController, IClickable {
    ...
    public void Click()
    {
        ...
        panel.OpenDialog("Police station", "Tear down the building and build a kebab shop!", DeleteBuildingAndBuildKebabBuilding, string.Format("Erase and build (-{0} cash)!", building.ReplaceCost()));
    }
